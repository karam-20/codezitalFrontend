      ...
      <div className="w-[270px] mx-auto border p-3">
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-3">
            <Link to={`/course/${id}`}>
              <button className="bg-[#632ede] w-full text-white text-sm font-medium py-2 px-2 rounded-md">
                Watch Now
              </button>
            </Link>

            <button
              className="bg-[#f1edfa] font-medium text-[#632ede] text-sm py-2 px-4 rounded-md"
          ...
          {categories.map((item, index) => (
            <div key={index} className="flex items-center justify-center m-2">
              <button
                ...
                className="bg-gray-100 rounded-md py-2 px-4 text-base font-medium"
              >
                {item}
              </button>
            </div>
